...
def main():
    def get_custom_datetime():
        ...
        Returns:
            datetime or None: The validated datetime object, or None if input is invalid.
        """
        try:
        ...
        if choice == '1':
            ...
            while True:
                ...
                if date_choice == '1':
                    ...
                    record_date = get_custom_datetime()
                    if record_date:
                        break
                else:
            ...
            # Pass all collected data to the method
